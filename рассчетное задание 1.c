...
int main() {
    ...
    printf("%d\n", det);
    if(det==0)
        printf("Векторы компланарны так, как их смешанное произведение равно 0.\n");
    else
        printf("Векторы не компланарны так, как их смешанное произведение не равно 0.\n");

    if((m1/m4 == m2/m5) && ((m2/m5 == m3/m6)) && ((m1/m7 == m2/m8)) && ((m2/m8 == m3/m9)) && ((m4/m7 == m5/m8)) && ((m5/m8 == m6/m9)))
            printf("Векторы линейно зависимы так, как их координаты пропорциональны:\n вектор a пропорционален вектору b с коээфициентом: %d\n вектор a пропорционален вектору c с коэффициентом: %d\n вектор b пропорционален вектору с с коэффициентом: %d\n",m4/m1, m7/m1, m7/m4);

    else
        printf("Векторы линейно независимы. Координаты векторов не пропорциональны.\n ");
    if (det==0)
        printf("Векторы не образуют базис, так как они линейно зависимы.\n");
    else
        printf("Векторы образуют базис пространства так, как они линейно независимы.\n");
    if (det>0)
        printf("Вектора образуют правую тройку так, как определитель больше 0.\n");
    if (det<0)
        printf("Векторы образуют левую тройку так, как определитель меньше 0.\n");
